        ...
        <div className="h-full w-full p-2 translate-y-[-3rem] flex flex-col justify-center align-center items-center">
          <div className="text-center m-5 flex flex-col md:flex-row">
            ...
            <div className=" p-5 m-5 rounded-xl flex flex-col">
              ...
              <p className="text-2xl md:text-5xl mt-5">With <span className="font-bold bg-gradient-to-r from-blue-600 to-violet-600 bg-clip-text text-transparent">Fast and Beautiful{" "}</span> websites <span>Tailoured{" "}</span>to <span className="font-bold">you</span></p>
            </div>
          </div>
          <div>
            <Button
