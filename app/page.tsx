...
export default function Home() {
    return (
        <section className="flex flex-col items-left justify-left gap-4 py-8 md:py-10 bg-herobg before:blur-2xl before:bg-gradient-readial after:blur-2xl after:bg-gradient-conic">
            <div
                className={
                    "bg-gradient-to-r from-sky-500 to-indigo-500 h-full z-1"
                }
            ></div>
            <div className="inline-block text-left justify-left z-2">
                ...
                <p className={subtitle({})}>
                    In today&spos;s digital world, it is more important than
                    ever for businesses to have a strong online presence. We are
                    a team of experienced web developers and designers who can
                    help you create a website that is both visually appealing
                    and easy to use. We will also help you optimize your website
                    for search engines so that potential customers can easily
                    find you online.
                </p>
            </div>
            ...
            <div className="flex flex-col items-right justify-right ">
                ...
                <div className="flex flex-col text-right">
                    <h1 className={title({ class: "mt-3 font-bold" })}>
                        What We Do
                    </h1>
                    <p className={subtitle({})}>
